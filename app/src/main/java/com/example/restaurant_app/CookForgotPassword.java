...
public class CookForgotPassword extends AppCompatActivity {
    EditText email;
    Button send_email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cook_forgot_password);
            ...
            public void onClick(View v) {
                ...
                call.enqueue(new Callback<ForgotResult>() {
                    ...
                    public void onFailure(Call<ForgotResult> call, Throwable t) {
                        Toast.makeText(CookForgotPassword.this, "Please! Check Network of Your Device",
