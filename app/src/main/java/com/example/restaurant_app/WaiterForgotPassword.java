...
public class WaiterForgotPassword extends AppCompatActivity {
    EditText email;
    Button send_email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_waiter_forgot_password);
                ...
                call.enqueue(new Callback<ForgotResult>() {
                    ...
                    public void onResponse(Call<ForgotResult> call, Response<ForgotResult> response) {
                        if (response.code() == 200) {
                            Toast.makeText(WaiterForgotPassword.this,
                                    "Check Your Email for Reset Password", Toast.LENGTH_LONG).show();

                            startActivity(new Intent(WaiterForgotPassword.this, Loginall.class));
                    ...
                    public void onFailure(Call<ForgotResult> call, Throwable t) {
                        Toast.makeText(WaiterForgotPassword.this, "Please! Check Network of Your Device",
